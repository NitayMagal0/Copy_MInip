...
class RenderTests {
   ...
   /**
    * Test for ambient light attenuation with material properties instead of emission
    */
   @Test
   void renderMultiColorTestMaterial() {
      Scene scene = new Scene("Multi color material").setAmbientLight(new AmbientLight(new Color(WHITE))); // New- Bright white ambient light
      scene.geometries //
              .add(// center
                      new Sphere(new Point(0, 0, -100), 50)
                              .setMaterial(new Material().setKA(new Double3(0.4))), // New- Material that reflects 40% of all ambient light colors
                      // up left
                      new Triangle(new Point(-100, 0, -100), new Point(0, 100, -100), new Point(-100, 100, -100))
                              .setMaterial(new Material().setKA(new Double3(0, 0.8, 0))), // Green triangle- Only reflects green ambient light
                      // down left
                      new Triangle(new Point(-100, 0, -100), new Point(0, -100, -100), new Point(-100, -100, -100))
                              .setMaterial(new Material().setKA(new Double3(0.8, 0, 0))),// Red triangle- Only reflects red ambient light
                      // down right
                      new Triangle(new Point(100, 0, -100), new Point(0, -100, -100), new Point(100, -100, -100))
                              .setMaterial(new Material().setKA(new Double3(0, 0, 0.8)))); // Blue triangle - Only reflects blue ambient light
      ...
      camera //
              ...
              .renderImage() //
              .printGrid(100, new Color(WHITE)) //
              .writeToImage("material ambient test");
   }
